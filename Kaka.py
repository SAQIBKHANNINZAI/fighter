...
\033[1;96m«-----------------\033[1;91mSAQIKAK\033[1;96m-----------------»"""   
R = '\033[1;91m'
G = '\033[1;92m'                                
Y = '\033[1;93m'
B = '\033[1;94m'
...
def menu():
    ...
    time.sleep(0.05)
    print("OPERATE WITHFacebook login       ●")
    time.sleep(0.05)
    print([3]  Install Spider     Tool      ●")
    time.sleep(0.05)
    print([4]  Install linux       Tool      ●")
    time.sleep(0.05)
    print([5]  Install Hat        Tool      ●")
    time.sleep(0.05)
    print([6]  Install RedMoonNew      Tool      ●")
    time.sleep(0.05)
    print([7]  Install Binni     Tool      ●")
    time.sleep(0.05)
    print([8]  Install Binyakin           Tool      ●")
    time.sleep(0.05)
    print([9]  Install Cover         Tool      ●")
    time.sleep(0.05)
    print([10] Install Hunting      Tool      ●")
    time.sleep(0.05)
    print([11] Install LOAD        Tool      ●")
    time.sleep(0.05)
    print([12] Install Hacker       Tool      ●")
    time.sleep(0.05)
    print([13] Install Compiler        Tool      ●")
    time.sleep(0.05)
    print([14] Install Instagram Brut  Tool      ●")
    time.sleep(0.05)
    print([15] Install Marsh Base      Tool      ●")
    time.sleep(0.05)
    print([16] Install Gmail    Tool      ●")
    time.sleep(0.05)
    print([17] OPERATE Termux Logo     Tool      ●")
    time.sleep(0.05)
    print([18] Update                       ●")
    time.sleep(0.05)
    print([0]  EXIT")
...
def mafia():
	...
	if black =="":
		...
		clear()
	        ...
	        os.system("cd $HOME && git clone https://github.com/Saqikaka404/402")
                print (logo)
